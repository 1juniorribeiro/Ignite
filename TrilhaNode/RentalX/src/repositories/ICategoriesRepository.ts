...
interface ICategoriesRepository {
  ...
  findByName(name: string): Category; // criamos o findbyname que vai receber um namoe em string que é do tipo category, a tipagem vem pelo model
  list(): Category[]; // criamos o metodo list que vai ser um array das categorias
  create({ name, description }: ICreateCategoryDTO): void; // criamos o metodo create que vai receber o nome e descrição que são do tipo DTO que retornam nada o void no caso
}
